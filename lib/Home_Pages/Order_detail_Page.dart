      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          SingleChildScrollView(
            padding:  EdgeInsets.only(left: width*0.04,top: height*0.04,right: width*0.04),
            child: Column(
              children: [
                Container(
                  child: Row(
                    children: [
                      ...
                      CustomText(text: "Order details",color: ColorConst.black,fontSize:24,fontWeight: FontWeight.w700,),
                    ],
                  ),
                ),
                SizedBox(height:30 ,),
                DesignColorCoustomContainer(child: Column(children: [Text("Hello")],),)
              ],
            ),
          )
        ],
